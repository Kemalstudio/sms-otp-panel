...
class Device extends Model
{
     ...
     * на 30 сообщениях за полчаса. Ровный поток в пару сообщений в минуту не
     * привлекает внимания антиспама оператора — а именно оператор решает,
     * жить SIM-карте или нет. Кому нужно больше, поднимает лимит в панели.
     */
    public const DEFAULT_THROUGHPUT_PER_MINUTE = 2;
